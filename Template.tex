...
\begin{frame}{Stationarity Issues}
	...
	\begin{itemize}
		\item \textbf{Nonstationarity and Regime Shift:}  DT may conflate regimes, failing to recognize when a feature distribution changes.
...
\begin{frame}{Model Updates}
	\begin{itemize}
		\item Incorporating state statistics to summarize the behavior and propoerties of the states
