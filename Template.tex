...
\begin{frame}{Stationarity Issues}
	...
	\begin{itemize}
		\item \textbf{Nonstationarity and Regime Shift:}  DT may conflate regimes, falling to recognize when a feature distribution changes.
...
\begin{frame}{State Statistics}
	\begin{itemize}
		...
		\item \textbf{Variance and Standard Deviation:} Measure the dispersion or risk.
		      ...
		      \]
		\item \textbf{Covariance and Correlation:} Quantify co-movements.
		      \[
...
\begin{frame}{State Statistics}
	The use of state statistics for Transformers is supported by research by Liu, Wu, Wang, and Long (2022).
...
\begin{frame}{Trajectories}
	This process of encoding trajectories is computationally expensive because it involves
...
\begin{frame}{High Performance Computing}
	High-performance computing (HPC) can significantly accelerate RL research for portfolio optimization, especially when using computationally intensive models such as decision transformers in complex regimes.
	\begin{itemize}
